"""
Seed script - creates initial data for SMT Downtime Tracker
"""
import asyncio
import sys
import os
...
logging.getLogger('sqlalchemy.engine.base').setLevel(logging.CRITICAL)
...
async def seed():
    ...
    async with AsyncSessionLocal() as db:
        ...
        print("  Barcodes: $EOP1, $EOP2, $EOP3, etc. (PIN: 1234)")
